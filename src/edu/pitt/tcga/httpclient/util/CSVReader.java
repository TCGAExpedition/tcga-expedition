...
public class CSVReader {
	...
	public CSVReader(Reader reader, char separator, char quotechar, int line) {
		...
		sepStr = Character.toString(separator);
	 ...
	 *
	 * ATTINTION: it does NOT handle empty values
	 */
	...
	public List<String[]> readAllToList() throws IOException {
		String sCurrentLine = null;
		
		List<String[]> allElements = new LinkedList<String[]>();
		while ((sCurrentLine = br.readLine()) != null) {
			allElements.add(sCurrentLine.split(sepStr, -1));
		}
		return allElements;
	}
	
	
	public List<String[]> readAllToList(int startRow) throws IOException {
		String sCurrentLine = null;
...
/*
	...
	public static int getColumnNumber(String[] strArr, String columnName){
		int i = 0;
		for(String s:strArr){
